...
export const claimStatusLabels: Record<ClaimStatus, string> = {
  ...
  DEMAND_LETTER_SENT: "Wezwanie wysłane",
  AWAITING_AIRLINE_RESPONSE: "Odpowiedź linii",
  NEGATIVE_RESPONSE: "Odmowa linii",
  COURT_DECISION_PENDING: "Decyzja sądowa",
  COURT_STAGE: "Etap sądowy",
  WON: "Wygrana",
  SETTLEMENT: "Ugoda",
  CLOSED_PAID: "Zamknięta i wypłacona",
  REJECTED: "Odrzucona",
  DISMISSED: "Oddalona",
};
...
export const claimStatusClasses: Record<ClaimStatus, string> = {
  ...
  MISSING_DATA: "border-amber-200 bg-amber-50 text-amber-700",
  ...
  COURT_DECISION_PENDING: "border-amber-200 bg-amber-50 text-amber-700",
